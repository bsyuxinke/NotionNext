...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '40d742a4a92b4291ac14bc676f73b33f',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '绘梦绘心，心灵心运，家居环境理气调节，心理调节',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '雨岫楼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '内外理气调节', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.mhs.ac.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '绘梦,绘心, 博客', // 网站关键词 英文逗号隔开
